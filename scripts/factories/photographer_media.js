 function mediaFactory(photographer, media,portrait) {
        ...
        //affichage prix et like

        var price = document.getElementById("price").innerHTML=`${photographer.price}€ / jour`;
        console.log(price)
...
function getUserCardDOM() {
    ...
    images.setAttribute("data-id",media.id);

    images.setAttribute("src", img);
    
// ouverture du modale
    images.onclick=()=>{launchModalPhoto(media.id,photographer.id)};
