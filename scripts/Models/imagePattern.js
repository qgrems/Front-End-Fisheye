    ...
    article.innerHTML = `
        ...
        <div>
            ...
            <div class="footer_heart_icon"> 
                <button  tabindex="-1" class= "buttonLikes button_heart" onclick=app.likesMedia.afficheLikes(${this._likes},${this._id})>
                <p class= "likes" class="like_margin addLike">${this.likes}</p>
                    <em  aria-label="likes" tabindex="${this._tableauMedia}"aria-label="likes" class="fas fa-heart"></em>
                </button>
            </div>
        </div>`
    return article
